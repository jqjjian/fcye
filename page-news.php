    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="news-classify">
          ...
          ?>
          <a href="<?php echo $url; ?>" role="button" class="btn btn-default <?php if(!$category){echo 'active';}?>">全部</a>
          <a href="<?php echo $url; ?>?category_id=13" role="button" class="btn btn-default <?php if($category&&$category==13){echo 'active';}?>">青创新闻</a>
          <a href="<?php echo $url; ?>?category_id=14" role="button" class="btn btn-default <?php if($category&&$category==14){echo 'active';}?>">行业新闻</a></div>
